                            ...
                            @foreach($replies as $reply)
                                <tr> 
                                    ...
                                    @foreach($categories as $category)
                                      @if($category->id == $reply->categories_id)
                                        <td>{{$category->title}}</td>
                                      @endif
                                    @endforeach
                                    <td>
                                        <a href="{{ route('deleteReply', $reply->id) }}" class="btn btn-danger">Delete Reply</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
