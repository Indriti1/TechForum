        ...
        <div class="container-fluid">
            <div class="row h-100">
                <div class="col-12 ml-4">
                    <div class="row">
                        <div class="card w-75">
                            <form method="POST" action="{{route('updateCategory',[$category->id])}}" id="form">
                                @csrf
                                <div class="col-12 p-4">
                                    <div class="form-group">
                                        <label for="categoryTitle" class="form-label"><h5>Category Name</h5></label>
                                        <input id="categoryTitle" type="text" class="form-control @error('categoryTitle') is-invalid @enderror" name="categoryTitle" value="{{old('categoryTitle') ?? $category->title}}" autofocus>
                                        @error('categoryTitle')
                                    ...
                                    <div class="form-group">
                                        <label for="description" class="form-label"><h5>Category Description</h5></label>
